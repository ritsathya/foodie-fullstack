  ...
  <div class="bg-white w-full p-12 mt-4 rounded">
    <form method="POST" action="{{ route('profile.setting.update') }}">
      ...
      <div class="mt-4 relative">
        ...
        <input type="password" name="old_password" id="email" class="bg-gray-100 w-full py-4 pl-8 border-2 rounded-lg shadow-inner @error('email') border-red-500 @enderror" placeholder="Enter Your Old Password" value="">
      </div>
      @error('email')
        <div class="my-2 text-red-500 text-sm">
          {{ $message }}
      ...
      <div class="mt-4 relative">
        ...
        <span class="pointer-events-none w-8 mt-3 text-gray-500 absolute top-1/2 transform -translate-y-1/2 left-3"><i class="fas fa-envelope"></i></span>
        <input type="password" name="new_password" id="email" class="bg-gray-100 w-full py-4 pl-8 border-2 rounded-lg shadow-inner @error('email') border-red-500 @enderror" placeholder="Enter Your New Password" value="">
      </div>
      @error('email')
        <div class="my-2 text-red-500 text-sm">
          {{ $message }}
      ...
      <div class="mt-4 relative">
        ...
        <span class="pointer-events-none w-8 mt-3 text-gray-500 absolute top-1/2 transform -translate-y-1/2 left-3"><i class="fas fa-envelope"></i></span>
        <input type="password" name="new_password_confirmation" id="email" class="bg-gray-100 w-full py-4 pl-8 border-2 rounded-lg shadow-inner @error('email') border-red-500 @enderror" placeholder="Confirm Your New Password" value="">
      </div>
      @error('email')
        <div class="my-2 text-red-500 text-sm">
          {{ $message }}
