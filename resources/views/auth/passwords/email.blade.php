...
@section('content')
  <div class="flex justify-center w-full h-screen">
    <div class="bg-white p-8 mt-[100px] rounded-lg shadow-xl w-4/12 sm:w-8/12 md:w-6/12 h-fit">
      <form method="POST" action="{{ route('password.email') }}">
        ...
        <div class="mb-4 relative">
          ...
          <input type="email" name="email" id="email" class="bg-gray-100 w-full py-4 pl-8 border-2 rounded-lg shadow-inner" placeholder="Put your email or username" value="" required>
        ...
        <div class="flex justify-center w-full">
          <span>
            Back to <a href="{{ route('login') }}" class="text-blue-500 hover:underline">login</a>
          </span>
        </div>
      </form>
    </div>
